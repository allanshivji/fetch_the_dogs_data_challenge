...
import { updateCities, updateStates, updateZipCodes, updateGeoLocations, updateFavorites, clearLocationFilters, clearAllFavorites } from '../actions';
...
const mapDispatchStateToProps = (dispatch: any) => ({
  ...
  updateFavorites: (favoriteIds: string[]) => dispatch(updateFavorites(favoriteIds)),
